                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('content') is-invalid @enderror" id="editor" name="content" rows="6">{{ old('content', $event->content) }}</textarea>
                                                    @error('content')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div id="image-preview" class="mt-2">
                                                        @if($event->image)
                                                            <img src="{{ asset('storage/events/' . $event->image) }}" class="img-fluid rounded" style="max-height: 200px;" alt="Current Image">
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="link_group" name="link_group" value="{{ old('link_group', $event->link_group) }}">
                                                    @error('link_group')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            value="{{ old('max_attendees', $event->max_attendees ?? 1) }}">
                                                        @error('max_attendees')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('location_name', $event->eventsLocation->name ?? '') }}" required>
                                                    @error('location_name')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('location_address') is-invalid @enderror" id="location_address"
                                                        name="location_address" rows="3" required>{{ old('location_address', $event->eventsLocation->address ?? '') }}</textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('location_city', $event->eventsLocation->city ?? '') }}" required>
                                                        @error('location_city')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                        ...
                                                        <select
                                                            ...
                                                            @foreach (['DKI Jakarta', 'Jawa Barat', 'Jawa Tengah', 'Jawa Timur', 'Banten', 'Yogyakarta', 'Bali', 'Sumatera Utara', 'Sumatera Barat', 'Riau', 'Sumatera Selatan', 'Lampung', 'Kalimantan Barat', 'Kalimantan Tengah', 'Kalimantan Selatan', 'Kalimantan Timur', 'Sulawesi Utara', 'Sulawesi Tengah', 'Sulawesi Selatan', 'Sulawesi Tenggara', 'Papua', 'Papua Barat'] as $province)
                                                                <option value="{{ $province }}"
                                                                    {{ old('location_province', $event->eventsLocation->province ?? '') == $province ? 'selected' : '' }}>
                                                                    {{ $province }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('location_country', $event->eventsLocation->country ?? 'Indonesia') }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="url"
                                                        ...
                                                        value="{{ old('location_map_url', $event->eventsLocation->map_url ?? '') }}">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <div id="ticket-types-container">
                                                    @php
                                                        $oldTickets = old('ticket_types', $event->ticketTypes->toArray());
                                                    @endphp
...
@section('script')
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            let ticketCount = {{ count(old('ticket_types', $event->ticketTypes->toArray())) }};
            ...
            function addNewTicket() {
                ...
                <div class="ticket-type mb-4 p-3 border rounded">
                    ...
                    <input type="hidden" name="ticket_types[${index}][id]" value="">
